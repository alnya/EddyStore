...
module.exports = {
  ...
  getReport: function(thisReport, thisData) {
    ...
    var output = ';EDDYPRO_PROCESSING' +
        ...
        '\nout_ghg_eu=' + EddyPro.formatBoolValue(outputOptions.GHG_Europe) +
        '\nout_amflux=' + EddyPro.formatBoolValue(outputOptions.AmeriFlux) +
        '\nout_rich=0' +
        '\nout_metadata=' + EddyPro.formatBoolValue(outputOptions.Metadata) +
        '\nout_biomet=' + EddyPro.formatBoolValue(outputOptions.Biomet_Measurements) +
        '\nmake_dataset=0' +
        '\npr_subset=0' +
        ...
        '\nhf_meth=1' +
        '\nlf_meth=1' +
        '\nwpl_meth=' + EddyPro.getLookupValue("Compensate_Density_Fluctuations_Method", processing.Compensate_Density_Fluctuations_Method) +
        ...
        '\nbiom_rec=0' +
        '\nbiom_ext=.txt' +
        '\nout_mean_cosp=' + EddyPro.formatBoolValue(outputOptions.Spectral_Output_Averaged_Cospectra) +
        '\nbin_sp_avail=0' +
        '\nfull_sp_avail=0' +
        '\nfiles_found=' + fs.readdirSync(EddyPro.getDataFolder(thisData.id)).length +
        '\n';
        ...
        if (spectral != null) {
          ...
          '\nf10_h_trshld=10' +
          '\nhorst_lens=2' +
          '\nex_file=' + EddyPro.getOutputFolder(thisData.id) + 'eddypro_test_1_essentials_2016-01-31T183136_exp.csv' +
          '\nsa_bin_spectra=' +
          '\nsa_full_spectra=' +
          '\nex_dir=' +
          '\nsa_subset=0' +
    ...
    output = output + '\n[RawProcess_TiltCorrection_Settings]' +
      ...
      '\npf_north_offset=' + EddyPro.formatValue(processing.Planar_North_Offset_First_Sector) +
      '\npf_min_num_per_sec=' + EddyPro.formatValue(processing.Planar_Elements_Per_Sector) +
      '\npf_w_max=' + EddyPro.formatValue(processing.Planar_Max_Mean_Verticle_Wind_Component) +
      '\npf_u_min=' + EddyPro.formatValue(processing.Planar_Min_Mean_Horizontal_Wind_Component) +
      '\npf_file=' +
      '\npf_fix=' +
      '\npf_subset=' +
      '\n';
    ...
    if (processing != null) {
      ...
      '\nto_file=' +
      '\nto_h2o_nclass=' + EddyPro.formatValue(processing.Time_Lag_RH_Classes) +
      '\nto_co2_min_flux=' + EddyPro.formatValue(processing.Time_Lag_Minimum_C02_Flux) +
      '\nto_ch4_min_flux=' + EddyPro.formatValue(processing.Time_Lag_Minimum_CH4_Flux) +
      '\nto_gas4_min_flux=' + EddyPro.formatValue(processing.Time_Lag_Minimum_Gas_Flux) +
      '\nto_le_min_flux=' +
      '\nto_pg_range=' + EddyPro.formatValue(processing.Time_Lag_Plausibility_Range_Around_Median_Value) +
      '\nto_co2_min_lag=' + EddyPro.formatValue(processing.Time_Lag_Searching_C02_Min) +
      '\nto_co2_max_lag=' + EddyPro.formatValue(processing.Time_Lag_Searching_C02_Max) +
      '\nto_h2o_min_lag=' + EddyPro.formatValue(processing.Time_Lag_Searching_H20_Min) +
      '\nto_h2o_max_lag=' + EddyPro.formatValue(processing.Time_Lag_Searching_H20_Max) +
      '\nto_ch4_min_lag=' + EddyPro.formatValue(processing.Time_Lag_Searching_CH4_Min) +
      '\nto_ch4_max_lag=' + EddyPro.formatValue(processing.Time_Lag_Searching_CH4_Max) +
      '\nto_gas4_min_lag=' + EddyPro.formatValue(processing.Time_Lag_Searching_Gas_Min) +
      '\nto_gas4_max_lag=' + EddyPro.formatValue(processing.Time_Lag_Searching_Gas_Max) +
      '\nto_subset=' +
      '\n';
    }
