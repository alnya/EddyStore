...
function (ko, moment, api, column, instrument) {
    ...
    Rotation_Method: ko.observable().extend(),
    Detrend_Method: ko.observable().extend(),
    Turbulent_Fluctuations_Time_Constant: ko.observable().extend({number:true}),
    Time_Lag_Compensation: ko.observable().extend(),
    Time_Lag_Method: ko.observable().extend(),
    Compensate_Density_Fluctuations: ko.observable().extend(),
    Compensate_Density_Fluctuations_Method: ko.observable().extend(),
    Add_Instrument_Sensible_Heat_Components: ko.observable().extend(),
    Surface_Temperature_Estimations: ko.observable().extend(),

    Tapering_Window:ko.observable().extend(),
    Frequency_Bins: ko.observable().extend({number:true}),
    Power_Of_Two_Samples: ko.observable().extend(),

    Quality_Check: ko.observable().extend(),
    Quality_Check_Flagging_Policy:ko.observable().extend(),
    Footprint_Estimation: ko.observable().extend(),
    Footprint_Method:ko.observable().extend(),
